	...
	<div class="board_wrap">
		...
		<c:forEach var="boards" items="${c1 }">
			<div class="board_view_wrap">
									...
									<td>
										<table>
											...
											<tr>
												...
												<c:if test="${tpc.c_writer == sessionScope.loginMember.u_id }">
													<td class="ctd2">
														<button class="cmBtn"
				...
				<div class="bt_wrap">
					<a href="board.go" class="on">목록</a>
					<c:if test="${boards.b_writer == sessionScope.loginMember.u_id }">
						<a href="board.edit.go?b_no=${boards.b_no }">수정</a>
						<a href="board.delete?b_no=${boards.b_no }">삭제</a>
					</c:if>
				</div>
			</div>
		</c:forEach>
