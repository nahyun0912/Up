...
$(function(){
   ...
   $.getJSON('subway.get', function(sg){
      $.each(sg.subway, function(i, s){
         ...
         var content = '<div class="wrap">' + 
           ...
           '        <div class="body">' + 
           '            <div class="desc">' + 
           '                <div class="ellipsis">'+s.sub_line_name+'</div>' + 
           '                <div class="jibun ellipsis">'+s.sub_telno_info+'</div>' +
           '            </div>' + 
           '        </div>' + 
           '    </div>' +    
           '</div>';
         ...
         kakao.maps.event.addListener(markers, 'click', function() {
            location.href="map.view.go?sub_no="+s.sub_no;
            });
         ...
         $("#mapSearch").click(function(){
            ...
            $.getJSON("sub.search?sub_station=" + search, function(ss){
               $.each(ss.subway, function(i, s){
                  //marker.setMap(null);
